...
<div id="box">
	...
	<form id="canteenForm" action="<%=path%>/tsCanteen" method="post">
	<input type="hidden" name="token" value="${token }">
	<div class="input-items">
		<span>食堂编号：</span><input type="text" name="tsCanteenNumber" value="">
	</div>
	<div class="input-items">
		<span>所属楼层：</span><input type="text" name="tsTowerNumber" value="">
	</div>
	<div class="input-items">
		<span>所属窗口：</span><input type="text" name="tsWindowNumber" value="">
	</div>
	<div class="input-items">
		<span>投诉原因：</span><input type="text" name="tsReason" value="">
	</div>
	<div class="input-items">
		<span>投诉时间：</span><input type="text" name="tsTime" value="">
	</div>
	<div class="input-items">
